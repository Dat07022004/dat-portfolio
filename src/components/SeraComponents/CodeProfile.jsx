...
export default function CodeProfile() {
    return <div className="flex items-center justify-center p-4 font-sans bg-white dark:bg-zinc-950">
        <CoderProfileCard />
    </div>;
}
const coderData = {
...
const CoderProfileCard = () => {
    return <div className="max-w-2xl w-full mx-auto bg-gradient-to-r from-zinc-100 to-zinc-200 dark:from-[#000000] dark:to-[#0a0d37] border-zinc-300 dark:border-[#1b2c68a0] relative rounded-lg border shadow-lg">
        ...
        <div className="overflow-hidden border-t-[2px] border-zinc-300 dark:border-indigo-900 px-4 lg:px-8 py-4 lg:py-8 relative">
            ...
            <div className="relative flex">
                <div className="hidden md:flex flex-col items-end pr-4 text-zinc-600 dark:text-gray-500 font-mono text-xs">
                    {Array.from({
                        length: 12
                    }, (_, i) => <div key={i} className="leading-relaxed select-none opacity-70">
                        {i + 1}
                    </div>)}
                </div>
                    ...
                    <div className="pl-6">
                        ...
                        <div className="pl-6 flex flex-wrap">
                            {coderData.skills.map((skill, index) => <span key={skill} className="mr-1">
                                ...
                                {index < coderData.skills.length - 1 && <span className="text-zinc-600 dark:text-gray-400">
                                    ,{" "}
                                </span>}
                            </span>)}
                        </div>
